...
class Service_Brand extends Miqo_Service_Base {
    private $validator = null;
    
    private static $VALIDATION_CONFIG = array (
            'name' => array (Miqo_Validation_Base::NOT_EMPTY, Miqo_Validation_Base::DB_NO_RECORD_EXISTS => array('table'=>Dao_DbTable_List::BRAND, 'field' => 'name')),
    );
    
    public function __construct() {
        parent::__construct();
        $this->dao = new Dao_Brand();
    }
    
    public function validate(Domain_Brand $domain) {
    ...
    public function &__t_save(Domain_Brand $domain) { 
